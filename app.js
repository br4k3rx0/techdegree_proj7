...
alertM.addEventListener('click', function(e) {
    const elm = e.target;
    if(elm.classList.contains("alert-banner-close")) {
...
sendBtn.addEventListener('click', function(e) {
    ...
    //     alert("Please fill out user and message fields before sending");
    // } else {
    //     let messageSection = document.querySelector('.msg-bal');
    //     messageSection.innerHTML = `<p><strong>Alert: You must to fill the fields</strong></p>`;
    //     messageSection.style.display = "inherit";
